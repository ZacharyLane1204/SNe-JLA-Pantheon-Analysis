...
if __name__ == '__main__':
    ...
    # p = 0 # JLA
    # p = 1 # Pantheon ss
    # p = 2 # Pantheon Plus ss
    # p = 3 # Pantheon Plus Full
    for p in p_list:

        if p == 0:
            input = np.loadtxt('JLA_full_input.txt')
            prefix = 'JLA_'
        elif p == 1:
            input = np.loadtxt('pantheon_sub_input.txt')
            prefix = 'Panth_'
        elif p == 2:
            input = np.loadtxt('pantheonPlus_sub_input.txt')
            prefix = 'PanthPlus_'
        elif p == 2:
            input = np.loadtxt('PantheonPlusFull.txt')
            prefix = 'Full_PanthPlus_'
