...
from zacspline_rename import spl # ZAC CHANGED THIS
...
if __name__ == '__main__':
	...
	c = 299792.458 # km/s
	Ntotal = 640   # Number of SNe # ZAC CHANGED THIS
	...
	Z = np.loadtxt('pantheon_sub_input.txt') # ZAC CHANGED THIS
	COVd = np.loadtxt('pantheon_sub_COVd.txt') # ZAC CHANGED THIS
